...
pub(crate) fn resolve_target_user_and_group(
    target_user_name_or_id: &Option<ElevateString>,
    target_group_name_or_id: &Option<ElevateString>,
